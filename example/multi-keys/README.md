...
- `stream-fn` (formerly flow): combine multiple numbers from 5 keys for calculation [yomo.run/stream-function](https://docs.yomo.run/stream-fn)
...
### 3. Run [stream-fn](https://docs.yomo.run/stream-fn)
