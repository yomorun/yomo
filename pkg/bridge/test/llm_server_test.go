...
`, string(body))
	...
	t.Run("POST /invoke", func(t *testing.T) {
		...
		body, _ := io.ReadAll(resp.Body)
		assert.Equal(t, "{\"content\":\"How can I assist you today?\",\"finish_reason\":\"stop\",\"token_usage\":{\"prompt_tokens\":13,\"completion_tokens\":26}}\n", string(body))
	})
