	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				dataF: &frame.AIRegisterFunctionAckFrame{Name: "get-weather", Tag: 0x61},
				data:  []byte{0x91, 0x10, 0x1, 0xb, 0x67, 0x65, 0x74, 0x2d, 0x77, 0x65, 0x61, 0x74, 0x68, 0x65, 0x72, 0x2, 0x1, 0x61},
			},
		},
		{
			name: "error",
