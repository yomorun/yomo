---
title: Concept
description: The Core of YoMo Serverless LLM Function
icon: 'code'
---
...
Internally use [typescript-json-schema](https://github.com/YousefED/typescript-json-schema) to generate the JSONSchema from the TypeScript type. 
